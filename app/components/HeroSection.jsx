...
export default function HeroSection() {
  return (
    <div className="relative bg-[url('/images/youngsproutstherapy-image-01.jpg')] bg-no-repeat bg-cover bg-center py-10 md:py-20 px-6 rounded-lg max-w-screen-2xl mx-auto">
